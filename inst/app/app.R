...
# }
if (!requireNamespace("MetaStat", quietly = TRUE)) {
  stop("The MetaStat package is not installed. Please install it before running the app.")
}
...
MetaStat::run_app(host = "0.0.0.0", port =3838) # Cambia MetaStat por el nombre de tu paquete
